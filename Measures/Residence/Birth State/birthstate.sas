 ...
 *	2. Filling in missings ;
	length W1_US_STATE_abbr_full $ 4;
	if W1_US_STATE_abbr^=' ' then W1_US_STATE_abbr_full=W1_US_STATE_abbr;
	if W1_US_STATE_abbr =' ' then W1_US_STATE_abbr_full=W1_RES_1_4_STATE_1;
	*	%freq_K1STATE(W1_US_STATE W1_US_STATE_abbr*W1_US_STATE_abbr_full*W1_RES_1_4_STATE_1);
 *	3. Coding Census Region ; 
	length W1_US_REGION_BORN $ 11;
